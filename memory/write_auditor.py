...
DNA_QUALITY_CHECKS = {
    ...
    'responsibilities': lambda v: isinstance(v, list) and len(v) >= 5,
    'non_responsibilities': lambda v: isinstance(v, list) and len(v) >= 3,
    'escalation_triggers': lambda v: isinstance(v, list) and len(v) >= 2,
...
print("agent_auditor.py created")
