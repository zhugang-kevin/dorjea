...
import os
os.makedirs("agents/manifests", exist_ok=True)
open("agents/manifests/__init__.py", "w").close()

with open("agents/meta_agent/manifest_manager.py", "w", encoding="utf-8") as f:
    f.write(content.strip())
print("manifest_manager.py created")
