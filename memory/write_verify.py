...
verify = """# verify.ps1 - Daily verification script for Dorjea AI Factory
...
with open("memory/check_db_verify.py", "w", encoding="utf-8") as f:
    f.write(dbcheck.strip())
